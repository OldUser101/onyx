...
fn lexicon_doc_fm_teal_alpha_actor_profile() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("fm.teal.alpha.actor.profile"),
        revision: None,
        description: None,
        defs: {
            let mut map = ::alloc::collections::BTreeMap::new();
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("featuredItem"),
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for FeaturedItem<'a> {
    fn nsid() -> &'static str {
...
pub struct Profile<'a> {
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub description_facets: std::option::Option<Vec<jacquard_common::types::value::Data<'a>>>,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub featured_item: std::option::Option<crate::fm_teal::alpha::actor::profile::FeaturedItem<'a>>,
}
...
pub struct ProfileBuilder<'a, S: profile_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<jacquard_common::CowStr<'a>>,
        ::core::option::Option<crate::fm_teal::alpha::actor::profile::FeaturedItem<'a>>,
    ),
...
impl<'a, S: profile_state::State> ProfileBuilder<'a, S> {
    ...
    pub fn featured_item(
        mut self,
        value: impl Into<Option<crate::fm_teal::alpha::actor::profile::FeaturedItem<'a>>>,
    ) -> Self {
    ...
    pub fn maybe_featured_item(
        mut self,
        value: Option<crate::fm_teal::alpha::actor::profile::FeaturedItem<'a>>,
    ) -> Self {
    ...
    S: profile_state::State,
{
    ...
    pub fn build(self) -> Profile<'a> {
        Profile {
            ...
            featured_item: self.__unsafe_private_named.6,
